...
LABEL io.nullables.weather_sprites.build-date=$BUILD_DATE
LABEL io.nullables.weather_sprites.name="weather-sprites"
LABEL io.nullables.weather_sprites.description="Weather sprites"
LABEL io.nullables.weather_sprites.url="https://nullables.io/"
LABEL io.nullables.weather_sprites.vcs-ref=$VCS_REF
LABEL io.nullables.weather_sprites.vcs-url="https://github.com/AlexRogalskiy/weather-sprites"
LABEL io.nullables.weather_sprites.vendor="Nullables.io"
LABEL io.nullables.weather_sprites.version=$VERSION
