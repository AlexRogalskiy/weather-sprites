...
const thunderstormTemplate: Record<SpritePattern.thunderstorm, SpriteTemplate> = {
    [SpritePattern.thunderstorm]: {
        style: () => {
            return `
                        .fog {
                            position: absolute;
...
export default thunderstormTemplate
