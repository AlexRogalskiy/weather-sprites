...
import { SpriteTemplate, SpriteTemplateRecord } from '../../../../core/typings/domain-types'
 ...
 */
const spritePatterns: Readonly<SpriteTemplateRecord> = {
 ...
 */
export const getSprite = (value: Optional<SpritePattern>): SpriteTemplate => {
